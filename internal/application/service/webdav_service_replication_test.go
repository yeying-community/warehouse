...
func TestShouldHardDeleteSyncArtifact(t *testing.T) {
	...
	testCases := []struct {
		...
		{path: "/apps/localhost-3020/backup.__sync_txn_head_v1.json", want: true},
		{path: "/apps/localhost-3020/backup.__sync_txn_head_v1_bak.json", want: true},
		...
		{path: "/alice/apps/localhost-3020/backup.__sync_txn_head_v1.json", want: true},
		{path: "/alice/apps/localhost-3020/backup.__sync_txn_head_v1_bak.json", want: true},
		...
		{path: "/personal/backup.__sync_txn_head_v1_bak.json", want: false},
